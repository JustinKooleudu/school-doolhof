...
public class PlayerController : MonoBehaviour
{
    ...
    public KeyCode FlashlightKey = KeyCode.Alpha1;
    public float FlashlightRange = 20f;
    public float FlashlightSize = 40f;
    public float FlashlightStrength = 1f;

    #endregion

    #region Compas
    
    public KeyCode CompasKey = KeyCode.Alpha2;
    ...
    public KeyCode zoomKey = KeyCode.Alpha3;
    public float zoomFOV = 30f;
    public float zoomStepTime = 5f;
    public float zoomspeedReduction = .5f;
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Gadgets Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();
        ...
        fpc.FlashlightKey = (KeyCode)EditorGUILayout.EnumPopup(new GUIContent("Flashlight Key", "Determines what key is used to turn the flashlight on and off."), fpc.FlashlightKey);
        fpc.FlashlightRange = EditorGUILayout.Slider(new GUIContent("Flashlight Range", "Determines the range of the flashlight."), fpc.FlashlightRange, 10f, 30f);
        fpc.FlashlightSize = EditorGUILayout.Slider(new GUIContent("Flashlight Size", "Determines the size of the flashlight spread."), fpc.FlashlightSize, 30f, 50f);
        fpc.FlashlightStrength = EditorGUILayout.Slider(new GUIContent("Flashlight Strength", "Determines the brightness of the flashlight."), fpc.FlashlightStrength, .5f, 1.5f);
        ...
        GUILayout.Label("Compass", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleLeft, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));

        fpc.CompasKey = (KeyCode)EditorGUILayout.EnumPopup(new GUIContent("Compas Key", "Determines what key is used to use the compas."), fpc.CompasKey);
        ...
        fpc.zoomspeedReduction = EditorGUILayout.Slider(new GUIContent("Speed Reduction", "Determines the percent 'Walk Speed' is reduced by. 1 being no reduction, and .5 being half."), fpc.zoomspeedReduction, .1f, 1);
        GUI.enabled = true;
